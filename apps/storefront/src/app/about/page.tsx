    ...
    <div>
      ...
      <section className="container-page py-16">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-muted leading-relaxed">
            GLOWN started from a simple frustration: finding genuinely good
            beauty and intimates products online usually meant wading through
            hundreds of near-identical listings, unclear sourcing, and prices
            that didn&apos;t match what showed up at the door. We wanted
            something simpler — a store where every product on the shelf is
            there because someone actually chose it, not because an algorithm
            needed inventory.
          </p>
          <p className="text-muted leading-relaxed">
            Today that means four categories done properly rather than twenty
            done halfheartedly: makeup that performs as well as it photographs,
            skincare built around real routines, fragrances worth reaching for
            daily, and lingerie that fits how it should. We add new arrivals
            every week, and we&apos;re just as picky about what we take off the
            shelf as what we put on it.
          </p>
        </div>
      </section>
      ...
      <section className="container-page py-16">
        <div className="max-w-3xl mx-auto text-center space-y-5">
          ...
          <p className="text-muted leading-relaxed">
            Our FAQ covers shipping, payment, and returns — or reach out
