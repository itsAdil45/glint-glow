...
import { LayoutDashboard, Package, FolderTree, ShoppingCart, Images, GalleryHorizontal, MessageSquareText, LibraryBig, Inbox, Truck, Ticket, LogOut } from "lucide-react";
